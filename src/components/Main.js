  ...
  return (
    <div class="text-white container m-auto">
      ...
      <h4 className="my-10 text-2xl">
        <button
          className="p-2 m-1 text-violet-600 border rounded-md text-md bg-zinc-800 border-zinc-400 hover:border-violet-600"
        ...
        <div class="flex flex-row justify-around ">
          <div class="bg-zinc-200 justify-center flex shadow-lg rounded p-1 m-4 w-24 h-24">
            <a href="./recipes" alt="Recipe Grabber" className="my-auto">
              <GiMeal className="text-4xl text-violet-600 scale-150 rounded bg-zinc-200 hover:scale-125" />
            </a>
          </div>
          <div class="bg-zinc-200 justify-center flex shadow-lg rounded p-1 m-4 w-24 h-24">
            <a href="./chat" alt="Chat" className="my-auto">
              <BsChatDotsFill className="justify-center p-1 text-4xl text-violet-600 scale-150 bg-zinc-200 hover:scale-125" />
            </a>
          </div>
          <div class="bg-zinc-200 justify-center flex shadow-lg rounded  p-1 m-4 w-24 h-24">
            <a href="./weather" alt="Weather" className="my-auto">
              <BsCloudFill className="text-2xl text-violet-600 scale-150 bg-zinc-200 hover:scale-125" />
            </a>
          </div>
        </div>
      </div>
